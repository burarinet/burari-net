...
export const metadata: Metadata = {
 ...
 icons:{
  icon:{url:'/application/files/6214/3800/7834/04.ico',type:'image/x-icon'},
  shortcut:'/application/files/6214/3800/7834/04.ico',
  apple:'/application/files/5714/3800/7786/03.png',
 },
};
